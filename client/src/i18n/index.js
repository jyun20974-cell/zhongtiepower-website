...
const enResources = {
  ...
  home: {
    ...
    companyOverviewSubtitle: 'Over 30 years of power equipment manufacturing experience, delivering reliable solutions worldwide.',
    ...
    advantage1Title: '30+ Years of Experience',
    advantage1Desc: 'Since 1992, dedicated to power equipment manufacturing with continuous innovation in processes and technology.',
    advantage1Data: 'Since 1992',
...
const zhResources = {
  ...
  home: {
    ...
    companyOverviewSubtitle: '30 余年电力设备制造经验，为全球客户提供可靠解决方案。',
    ourAdvantages: '核心优势',
    ...
    getFreeQuote: '免费获取报价',
    advantage1Title: '30 余年制造经验',
    advantage1Desc: '自 1992 年起深耕电力设备制造，不断创新工艺与技术，确保每一台设备的可靠性与高性能。',
    advantage1Data: '1992 年创立',
